...
metadata {
    ...
    tiles {
        ...
        */
        ...
        main(["status", "power", "energy", "voltage", "amperage"])
        details(["status", "deviceMode", "power", "energy", "amperage", "voltage", "refresh",
                 "levelSliderControl", "levelSliderTxt", "rgbSelector", "configure",  "reset"])
    }
}
